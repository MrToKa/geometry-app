...
const App = () => {
  ...
  const [freeWidthPercentage, setFreeWidthPercentage] = useState(0);
  ...
  const drawShapes = (width, height, spacing, groups) => {
    ...
    ctx.save();
    ctx.translate(50 + width + textPadding, 50 + height / 2);
    ...
    <div className="App">
      ...
      {result !== null && (
        <div>
          ...
          <p>Percentage of free width: {freeWidthPercentage.toFixed(2)}%</p>
        </div>
      )}
